...
$(document).ready(() => {
        ...
        init: function() {
            this.on("addedfile", function(file) {
                ...
                reader.addEventListener("load", function(event) {
                    ...
                    var max_width = max_height / copy.height * copy.width
                    ...
                    data3 = ndarray(new Float32Array(width * height * 3), [width, height, 3]);

                    ops.assign(data3.pick(null, null, 0), data2.pick(null, null, 0));
                    ops.assign(data3.pick(null, null, 1), data2.pick(null, null, 1));
                    ops.assign(data3.pick(null, null, 2), data2.pick(null, null, 2));

                    console.log(data2);
                    data2 = null;
                    console.log(data3);

                    //console.log('kesz a kep');
                    run();
    ...
    function run() {
        ...
        model.ready().then(() => {
            ...
            console.log(err, "Problem with model ready");
        })
    }
